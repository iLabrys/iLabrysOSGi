...
public class ConfigurationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigurationPackage.CONFIGURATION_CONTAINER_TYPE: {
				ConfigurationContainerType configurationContainerType = (ConfigurationContainerType)theEObject;
				T result = caseConfigurationContainerType(configurationContainerType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.CONFIGURATION_FILES_TYPE: {
				ConfigurationFilesType configurationFilesType = (ConfigurationFilesType)theEObject;
				T result = caseConfigurationFilesType(configurationFilesType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.CONFIGURATION_FILE_TYPE: {
				ConfigurationFileType configurationFileType = (ConfigurationFileType)theEObject;
				T result = caseConfigurationFileType(configurationFileType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.CONFIGURATION_PROPERTIES_TYPE: {
			...
			case ConfigurationPackage.CONTAINERS_TYPE: {
				ContainersType containersType = (ContainersType)theEObject;
				T result = caseContainersType(containersType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ConfigurationPackage.ENVIRONMENT_PROPERTY_TYPE: {
			...
			case ConfigurationPackage.ENVIRONMENT_TYPE: {
	 ...
	 * @generated
	 */
	public T caseConfigurationContainerType(ConfigurationContainerType object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseConfigurationFilesType(ConfigurationFilesType object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseConfigurationFileType(ConfigurationFileType object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Containers Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Containers Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseContainersType(ContainersType object) {
		return null;
	}
