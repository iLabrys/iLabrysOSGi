 ...
 * <ul>
 *   <li>{@link es.itecban.deployment.model.deployment.unit.impl.TypesTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypesTypeImpl extends EObjectImpl implements TypesType {
	...
	protected EClass eStaticClass() {
		return UnitPackage.Literals.TYPES_TYPE;
	}
	...
	public List<String> getType() {
		if (type == null) {
			type = new BasicInternalEList<String>(String.class);
		}
		return type;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnitPackage.TYPES_TYPE__TYPE:
				return getType();
		}
