 ...
 * <ul>
 *   <li>{@link es.itecban.deployment.model.deployment.unit.impl.PropertyTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.itecban.deployment.model.deployment.unit.impl.PropertyTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyTypeImpl extends EObjectImpl implements PropertyType {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnitPackage.PROPERTY_TYPE__NAME:
				return getName();
			case UnitPackage.PROPERTY_TYPE__VALUE:
				return getValue();
		}
	...
	public boolean equals(Object arg0) {
		if(!(arg0 instanceof PropertyType)) return false;
		PropertyType n = (PropertyType) arg0;
		String nn = n.getName();
		String nv = n.getValue();
