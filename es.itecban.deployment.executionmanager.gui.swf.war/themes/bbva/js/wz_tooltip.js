...
config. BgColor 		= '#E4F1FF' // Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#4E80C0'
...
config. FontFace		= 'Trebuchet MS, Verdana, Geneva, Arial, Helvetica, sans-serif';
...
config. Width			= 415 		// Tooltip width; 0 for automatic adaption to tooltip content; < -1 (e.g. -240) for a maximum width for that automatic adaption;
