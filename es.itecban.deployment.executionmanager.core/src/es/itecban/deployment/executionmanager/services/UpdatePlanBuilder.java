...
public interface UpdatePlanBuilder extends PlanBuilder {
	...
	//mjb necessary for the activities of installation under the updating flow
	boolean assignGroupToContainerForInstall(DeploymentGroup group,
			String containerName, boolean allowNotSuitableContainer);
}
