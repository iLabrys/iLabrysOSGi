...
public class GraphFactoryImpl extends EFactoryImpl implements GraphFactory {
	...
	public static GraphFactory init() {
		try {
			GraphFactory theGraphFactory = (GraphFactory)EPackage.Registry.INSTANCE.getEFactory("http://model.deployment.itecban.es/EnvironmentGraph"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case GraphPackage.ENVIRONMENT_GRAPH: return createEnvironmentGraph();
	 ...
	 * @generated
	 */
	public EnvironmentGraph createEnvironmentGraph() {
		EnvironmentGraphImpl environmentGraph = new EnvironmentGraphImpl();
