...
import es.itecban.deployment.model.environment.graph.impl.DependencyImpl;
 ...
 * <ul>
 *   <li>{@link es.itecban.deployment.model.environment.graph.impl.DependencyImpl#getCause <em>Cause</em>}</li>
 *   <li>{@link es.itecban.deployment.model.environment.graph.impl.DependencyImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link es.itecban.deployment.model.environment.graph.impl.DependencyImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.itecban.deployment.model.environment.graph.impl.DependencyImpl#getLocality <em>Locality</em>}</li>
 *   <li>{@link es.itecban.deployment.model.environment.graph.impl.DependencyImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
//	@Override
//	public String toString() {
//		return getSource().getUnitName() + " " + getSource().getUnitVersion() + " in " +
//				getSource().getContainerName() + " --> " +
//				getDestination().getUnitName() + " " + getDestination().getUnitVersion() + " in " +
//				getDestination().getContainerName();
//	}
	/**
	 * @generated NOT
	 */
